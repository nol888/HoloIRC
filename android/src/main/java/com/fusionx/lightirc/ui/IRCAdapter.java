...
public class IRCAdapter<T extends Event> extends RecyclerView.Adapter<IRCAdapter.IRCViewHolder>
    ...
    public void onBindViewHolder(final IRCViewHolder holder, final int position) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            Linkify.addLinks(holder.message, Linkify.EMAIL_ADDRESSES);
            Linkify.addLinks(holder.message, WEB_URL, null);
        } else {
    ...
    // The following regular expressions are copied from android.util.Patterns for API versions which
    // match against a hardcoded list of gTLDs.
